Извините, изначально залила реп без package.json. Заметила, только сейчас. Когда увидела первую проверку. package.json залила, перепроверьте, пожалуйста, работу.
